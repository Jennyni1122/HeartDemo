...
public class Page {
    ...
    public void setPagedView(String path) {
        ...
        sb.append("文档总数: " + totalRows + ", 共" + totalPages + "页, 第"
                + currentPage + "页, 转到 ");
        sb.append("<INPUT type=text size=5 name=page id=\"pageNo\" value=" + currentPage + ">");
        sb.append("&nbsp;");
    ...
    public void setPagedView() {
        ...
        StringBuffer sb = new StringBuffer();
        sb.append("<br/><TABLE width='100%' class='content9' cellpadding='0' cellspacing='0'>");
        sb.append("<TBODY>");
        sb.append("<TR>");
        ...
        if (hasPreviousPage) {
            ...
            sb.append("<input type='button' value='首页'  class='but_shop' onclick='search_pagedForm(1);return false;'>");
            sb.append("&nbsp;&nbsp;");
            sb.append("<input type='button' value='上一页' class='but_shop' onclick='search_pagedForm("
                    + (currentPage - 1)
                    + ");return false;'>");
            ...
            sb.append("<input type='button' value='首页' class='but_shop' onclick='search_pagedForm(1);return false;' disabled='disabled'>");
            sb.append("&nbsp;&nbsp;");
            sb.append("<input type='button' value='上一页' class='but_shop' onclick='search_pagedForm("
        ...
        sb.append("&nbsp;&nbsp;");
        if (hasNextPage) {
            sb.append("<input type='button' value='下一页' class='but_shop' onclick='search_pagedForm("
                    + (currentPage + 1) + ");return false;'>");
            //sb.append("<a href='#' onclick='search_pagedForm("
            //				+ (currentPage + 1)
            //				+ ");return false;'><IMG title='下一页' src='../../images/2.gif' border=0></a>");
            sb.append("&nbsp;&nbsp;");
            sb.append("<input type='button' value='末页' class='but_shop' onclick='search_pagedForm("
        ...
        sb.append("<INPUT name=totalRows type=hidden value='" + totalRows
                + "'>");
        sb.append("&nbsp;&nbsp;");
        sb.append("<INPUT onclick='submit_pagedForm()' type='button' value='GO' class='but_shop'>");
        sb.append("&nbsp;&nbsp;");
        sb.append("</TD>");
        sb.append("</TR>");
        sb.append("</TBODY>");
        ...
        sb.append("if(parseInt(pageSize) <1) {document.pagedForm.pageSize.value =1;}\n");
        sb.append("if(parseInt(pageSize) >50) {document.pagedForm.pageSize.value =50;}\n");

        sb.append("document.forms[0].submit();\n");
        sb.append("}\n");
        sb.append("function search_pagedForm(page) {\n");
        sb.append("jQuery(\"#pageNo\").val(page);\n");
