...
public abstract class BaseController {
    ...
    public abstract String getOperateColumn(List<EResource> re, AbstractEntity ae);//创建列表按钮方法

    public abstract String getOperateButton(List<EResource> re,String[] params);//创建BUTTON按钮方法
}
